...
export function EditModeBanner({ editablePlanData, events, onSave, role = 'student' }: EditModeBannerProps) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[7px] border border-[color-mix(in_srgb,var(--action-edit)_52%,transparent)] bg-[color-mix(in_srgb,var(--action-edit)_12%,white)] px-6 py-4 shadow-[0_34px_120px_-64px_rgba(253,204,74,0.55)]">
      ...
      <div className="relative flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-start gap-3">
          <span className="flex h-12 w-12 items-center justify-center rounded-[7px] border border-[color-mix(in_srgb,var(--action-edit)_52%,transparent)] bg-[color-mix(in_srgb,var(--action-edit)_16%,transparent)] text-[color-mix(in_srgb,#6b4b05_70%,var(--action-edit)_30%)]">
