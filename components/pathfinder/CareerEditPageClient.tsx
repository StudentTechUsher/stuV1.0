...
import {
  saveCareerDraft,
  publishCareer as publishCareerFn,
  useCareer,
} from '@/lib/hooks/useCareers';
import CareerEditForm from '@/components/pathfinder/CareerEditForm';
import type { Career } from '@/types/career';

interface CareerEditPageClientProps {
  slug: string;
}

export default function CareerEditPageClient({
  slug,
}: Readonly<CareerEditPageClientProps>) {
